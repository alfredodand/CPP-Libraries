...
void stestBinaryTreeInt(lasd::BinaryTree<int>& bt, unsigned int& testnum, unsigned int& testerr) {
  ...
  try {
    Map(loctestnum, loctesterr, bt, true, &MapPrint<int>);
    MapPreOrder(loctestnum, loctesterr, bt, true, &MapPrint<int>);
...
void stestBinaryTreeFloat(lasd::MutableBinaryTree<double>& bt, unsigned int& testnum, unsigned int& testerr) {
  unsigned int loctestnum = 0, loctesterr = 0;
  try {
