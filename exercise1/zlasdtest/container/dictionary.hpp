...
template <typename Data>
void InsertAllC(unsigned int& testnum, unsigned int& testerr, lasd::DictionaryContainer<Data>& con, bool chk, const lasd::MappableContainer<Data>& mc) {
  testnum++;
  bool tst = true;
  try {
...
template <typename Data>
void RemoveAll(unsigned int& testnum, unsigned int& testerr, lasd::DictionaryContainer<Data>& con, bool chk, const lasd::MappableContainer<Data>& mc) {
  testnum++;
  bool tst = true;
  try {
...
template <typename Data>
void InsertSomeC(unsigned int& testnum, unsigned int& testerr, lasd::DictionaryContainer<Data>& con, bool chk, const lasd::MappableContainer<Data>& mc) {
  testnum++;
  bool tst = true;
  try {
    std::cout << " " << testnum << " (" << testerr << ") Insertion in the dictionary container of the values of the given mappable container; ";
...
template <typename Data>
void RemoveSome(unsigned int& testnum, unsigned int& testerr, lasd::DictionaryContainer<Data>& con, bool chk, const lasd::MappableContainer<Data>& mc) {
  testnum++;
  bool tst = true;
  try {
    std::cout << " " << testnum << " (" << testerr << ") Removal from the dictionary container of the values of the given mappable container; ";
    std::cout << ((tst = con.InsertAll(mc)) ? "some value" : "none of the values") << " has been removed: ";
    std::cout << ((tst = (tst == chk)) ? "Correct" : "Error") << "!" << std::endl;
  } catch(std::exception exc) {
    tst = false;
    std::cout << "\"" << exc.what() << "\": " << "Error!" << std::endl;
