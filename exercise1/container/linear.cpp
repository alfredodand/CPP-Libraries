...
namespace lasd {
    ...
    template <typename Data>
    inline void LinearContainer<Data>::Fold(FoldFunctor fun, void * x) const {
        PreOrderFold(fun, x);
    }

    //Specific member function inherited from PreOrderFoldableContainer
    template <typename Data>
    inline void LinearContainer<Data>::PreOrderFold(FoldFunctor fun, void * x) const {
    ...
    template <typename Data>
    inline void LinearContainer<Data>::PostOrderFold(FoldFunctor fun, void * x) const {
