...
void stestBSTInt(unsigned int& testnum, unsigned int& testerr) {
  ...
  try {
    ...
    MapInOrder(loctestnum, loctesterr, (const lasd::BST<int>) bst2, true, &MapPrint<int>);
    MapInOrder(loctestnum, loctesterr, (const lasd::BST<int>) bst3, true, &MapPrint<int>);
...
void stestBSTFloat(unsigned int& testnum, unsigned int& testerr) {
  ...
  try {
    ...
    MapPreOrder(loctestnum, loctesterr, (const lasd::BST<double>) bst1, true, &MapPrint<double>);
    MapInOrder(loctestnum, loctesterr, (const lasd::BST<double>) bst1, true, &MapPrint<double>);
    MapPostOrder(loctestnum, loctesterr, (const lasd::BST<double>) bst1, true, &MapPrint<double>);
    MapBreadth(loctestnum, loctesterr, (const lasd::BST<double>) bst1, true, &MapPrint<double>);
